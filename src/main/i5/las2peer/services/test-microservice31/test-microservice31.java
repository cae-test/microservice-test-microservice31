package i5.las2peer.services.test-microservice31;
...
@ServicePath("test")
@ManualDeployment
public class test-microservice31 extends RESTService {





  public test-microservice31() {
	super();
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "test-microservice31", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "test", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/cae-test/microservice-test-microservice31/blob/master/LICENSE.txt") ) )
  @Path("/")
  public static class RootResource {

    private final test-microservice31 service = (test-microservice31) Context.getCurrent().getService();
